...
export const userTrustScoresTable = pgTable("user_trust_scores", {
  ...
  cvs: real("cvs").notNull().default(50),
  bcs: real("bcs").notNull().default(100),
  cts: real("cts").notNull().default(50),
  avgCis: real("avg_cis").notNull().default(50),
  uti: real("uti").notNull().default(50),
  visibilityMultiplier: real("visibility_multiplier").notNull().default(1.0),
